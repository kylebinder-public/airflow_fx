...
with DAG(
    ...
    forex_processing = SparkSubmitOperator(
        ...
        application="/opt/airflow/dags/scripts/forex_processing.py",  # remember: this script runs in Spark, not Airflow
        conn_id="spark_conn",
        verbose=False,
    )

    is_forex_rates_available >> is_fx_csv_available >> call_download_rates >> saving_rates
